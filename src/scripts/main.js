class Slider {
    ...
    /** Função resposnável por alterar a imagem do slider por meio de um modificador, 
    * considerando que cada slider pode ser representado como um array do path das iamgens
